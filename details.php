...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "megha");
    if (!$conn) {
    ...
    ?>
    <div style="font-family: 'Poppins', sans-serif;  font-size: 40px;
    text-align: center;
    margin: 20px;
}">
    ...
    <div class="card container">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "megha");
        ...
        <br><br>
        <a href="transfer.php"><button id="transfer" name="transfer" ;>Transfer Now</button></a>
      </form>
    </div>
    ...
    <div id="hojaplz">
      <img src="https://image.flaticon.com/icons/png/512/812/812847.png" id="menuBtn">
    </div>
